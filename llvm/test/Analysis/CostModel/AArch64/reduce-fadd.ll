...
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:54 CodeSize:51 Lat:62 SizeLat:54 for: %fadd_v4f8 = call bfloat @llvm.vector.reduce.fadd.v4bf16(bfloat 0xR0000, <4 x bfloat> undef)
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
; CHECK-F16-LABEL: 'strict_fp_reductions_bf16'
; CHECK-F16-NEXT:  Cost Model: Found costs of RThru:54 CodeSize:51 Lat:62 SizeLat:54 for: %fadd_v4f8 = call bfloat @llvm.vector.reduce.fadd.v4bf16(bfloat 0xR0000, <4 x bfloat> undef)
; CHECK-F16-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
...
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:48 CodeSize:48 Lat:60 SizeLat:48 for: %fadd_v8f16 = call fast half @llvm.vector.reduce.fadd.v8f16(half 0xH0000, <8 x half> undef)
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:48 CodeSize:48 Lat:60 SizeLat:48 for: %fadd_v8f16_reassoc = call reassoc half @llvm.vector.reduce.fadd.v8f16(half 0xH0000, <8 x half> undef)
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:72 CodeSize:72 Lat:88 SizeLat:72 for: %fadd_v16f16 = call fast half @llvm.vector.reduce.fadd.v16f16(half 0xH0000, <16 x half> undef)
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:72 CodeSize:72 Lat:88 SizeLat:72 for: %fadd_v16f16_reassoc = call reassoc half @llvm.vector.reduce.fadd.v16f16(half 0xH0000, <16 x half> undef)
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:203 CodeSize:143 Lat:215 SizeLat:203 for: %fadd_v11f16 = call fast half @llvm.vector.reduce.fadd.v11f16(half 0xH0000, <11 x half> undef)
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:248 CodeSize:170 Lat:260 SizeLat:248 for: %fadd_v13f16_reassoc = call reassoc half @llvm.vector.reduce.fadd.v13f16(half 0xH0000, <13 x half> undef)
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
...
; CHECK-BF16-NEXT:  Cost Model: Found costs of RThru:48 CodeSize:48 Lat:60 SizeLat:48 for: %fadd_v8f16 = call fast half @llvm.vector.reduce.fadd.v8f16(half 0xH0000, <8 x half> undef)
; CHECK-BF16-NEXT:  Cost Model: Found costs of RThru:48 CodeSize:48 Lat:60 SizeLat:48 for: %fadd_v8f16_reassoc = call reassoc half @llvm.vector.reduce.fadd.v8f16(half 0xH0000, <8 x half> undef)
; CHECK-BF16-NEXT:  Cost Model: Found costs of RThru:72 CodeSize:72 Lat:88 SizeLat:72 for: %fadd_v16f16 = call fast half @llvm.vector.reduce.fadd.v16f16(half 0xH0000, <16 x half> undef)
; CHECK-BF16-NEXT:  Cost Model: Found costs of RThru:72 CodeSize:72 Lat:88 SizeLat:72 for: %fadd_v16f16_reassoc = call reassoc half @llvm.vector.reduce.fadd.v16f16(half 0xH0000, <16 x half> undef)
; CHECK-BF16-NEXT:  Cost Model: Found costs of RThru:203 CodeSize:143 Lat:215 SizeLat:203 for: %fadd_v11f16 = call fast half @llvm.vector.reduce.fadd.v11f16(half 0xH0000, <11 x half> undef)
; CHECK-BF16-NEXT:  Cost Model: Found costs of RThru:248 CodeSize:170 Lat:260 SizeLat:248 for: %fadd_v13f16_reassoc = call reassoc half @llvm.vector.reduce.fadd.v13f16(half 0xH0000, <13 x half> undef)
; CHECK-BF16-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
...
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:28 CodeSize:28 Lat:32 SizeLat:28 for: %fadd_v4f8 = call reassoc bfloat @llvm.vector.reduce.fadd.v4bf16(bfloat 0xR8000, <4 x bfloat> undef)
; CHECK-NOFP16-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
; CHECK-F16-LABEL: 'fast_fp_reductions_bf16'
; CHECK-F16-NEXT:  Cost Model: Found costs of RThru:28 CodeSize:28 Lat:32 SizeLat:28 for: %fadd_v4f8 = call reassoc bfloat @llvm.vector.reduce.fadd.v4bf16(bfloat 0xR8000, <4 x bfloat> undef)
; CHECK-F16-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
