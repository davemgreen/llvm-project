...
define float @scalarize_load(i64 %22, ptr %23, ptr %rawA, ptr %rawB) {
; CHECK-LABEL: scalarize_load:
; CHECK:       // %bb.0: // %entry
...
define float @scalarize_load_sext(i64 %22, ptr %23, ptr %rawA, ptr %rawB) {
; CHECK-LABEL: scalarize_load_sext:
; CHECK:       // %bb.0: // %entry
...
define float @scalarize_load_zext(i64 %22, ptr %23, ptr %rawA, ptr %rawB) {
; CHECK-LABEL: scalarize_load_zext:
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    ldp q0, q2, [x1]
; CHECK-NEXT:    ldp q4, q1, [x1, #32]
