...
; CHECK-NEXT:    stp x30, x21, [sp, #80] // 16-byte Folded Spill
...
; CHECK-NEXT:    .cfi_offset w30, -32
; CHECK-NEXT:    stp q1, q0, [sp, #48] // 32-byte Folded Spill
...
; CHECK-NEXT:    cmp w0, #0
; CHECK-NEXT:    csinv w21, w19, wzr, le
; CHECK-NEXT:    bl __getf2
; CHECK-NEXT:    ldr q0, [sp, #64] // 16-byte Folded Reload
; CHECK-NEXT:    mov w19, w0
; CHECK-NEXT:    bl __fixunstfsi
...
; CHECK-NEXT:    csinv w8, w19, wzr, le
; CHECK-NEXT:    fmov s0, w8
; CHECK-NEXT:    mov v0.s[1], w21
; CHECK-NEXT:    ldp x30, x21, [sp, #80] // 16-byte Folded Reload
; CHECK-NEXT:    mov v0.s[2], w20
...
; CHECK-NEXT:    csel w17, w18, w8, lo
; CHECK-NEXT:    fcvtzu w18, d5
; CHECK-NEXT:    mov v0.h[2], w11
; CHECK-NEXT:    fmov s1, w17
; CHECK-NEXT:    fcvtzu w11, d6
; CHECK-NEXT:    mov v1.h[1], w16
; CHECK-NEXT:    cmp w18, w8
; CHECK-NEXT:    mov v0.h[3], w12
; CHECK-NEXT:    csel w15, w18, w8, lo
...
; CHECK-NEXT:    mov v0.h[4], w13
; CHECK-NEXT:    cmp w12, w8
; CHECK-NEXT:    csel w12, w12, w8, lo
; CHECK-NEXT:    mov v1.h[3], w14
; CHECK-NEXT:    mov v0.h[5], w0
; CHECK-NEXT:    mov v1.h[4], w11
; CHECK-NEXT:    fcvtzu w11, d7
; CHECK-NEXT:    mov v0.h[6], w10
; CHECK-NEXT:    mov v1.h[5], w12
; CHECK-NEXT:    cmp w11, w8
; CHECK-NEXT:    fcvtzu w12, d2
; CHECK-NEXT:    csel w11, w11, w8, lo
