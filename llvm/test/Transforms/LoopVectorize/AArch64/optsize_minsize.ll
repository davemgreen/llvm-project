...
; MINSIZE-NEXT:    [[TMP1:%.*]] = shl nuw i64 [[TMP0]], 1
...
; MINSIZE-NEXT:    [[TMP16:%.*]] = call <vscale x 2 x i8> @llvm.stepvector.nxv2i8()
...
; MINSIZE-NEXT:    [[VEC_IND:%.*]] = phi <vscale x 2 x i8> [ [[TMP16]], %[[VECTOR_PH]] ], [ [[VEC_IND_NEXT:%.*]], %[[VECTOR_BODY]] ]
; MINSIZE-NEXT:    [[TMP17:%.*]] = mul <vscale x 2 x i8> [[BROADCAST_SPLAT]], [[VEC_IND]]
; MINSIZE-NEXT:    [[TMP10:%.*]] = lshr <vscale x 2 x i8> [[VEC_IND]], splat (i8 1)
; MINSIZE-NEXT:    [[TMP11:%.*]] = mul <vscale x 2 x i8> [[TMP10]], [[BROADCAST_SPLAT2]]
; MINSIZE-NEXT:    [[TMP18:%.*]] = add <vscale x 2 x i8> [[TMP11]], [[TMP17]]
; MINSIZE-NEXT:    [[TMP13:%.*]] = lshr <vscale x 2 x i8> [[VEC_IND]], splat (i8 2)
; MINSIZE-NEXT:    [[TMP14:%.*]] = mul <vscale x 2 x i8> [[TMP13]], [[BROADCAST_SPLAT4]]
; MINSIZE-NEXT:    [[TMP15:%.*]] = add <vscale x 2 x i8> [[TMP18]], [[TMP14]]
; MINSIZE-NEXT:    [[TMP22:%.*]] = getelementptr inbounds i8, ptr [[P]], i64 [[INDEX]]
; MINSIZE-NEXT:    call void @llvm.masked.store.nxv2i8.p0(<vscale x 2 x i8> [[TMP15]], ptr align 1 [[TMP22]], <vscale x 2 x i1> [[ACTIVE_LANE_MASK]])
